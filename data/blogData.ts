...
export const BlogData: BlogDataProp[] = [
  {
    title: "🌾 From Village Roots to Digital Dreams",
    description:
      "How belief, values, and effort helped me move from a small village to the tech world.",
  ...
  },
  {
    ...
    description:
      "How coding shaped the way I solve problems and think in structured steps.",
  ...
  },
  {
    ...
    description:
      "A trip to Kollimalai gave me the mental reset I needed to reflect and refocus.",
  ...
  },
  {
    ...
    description:
      "Managing expectations and emotions to stay on track with my goals.",
  ...
  },
  {
    ...
    description:
      "How I use patience, repetition, and belief to grow — even when it’s hard.",
...

  {
    ...
    description:
      "A letter to remind my future self that I started from zero — and kept going.",
